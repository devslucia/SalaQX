    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="flex items-start gap-4 min-w-0">
          <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl text-primary-foreground shadow-sm ring-1 ring-primary/20 bg-gradient-to-br from-primary to-info">
          ...
          <div className="min-w-0 pt-0.5">
            ...
            <p className="mt-1.5 text-sm text-muted-foreground/90 leading-relaxed max-w-2xl">
              {user.rol === "medico"
      ...
      <Dialog open={detailId !== null} onOpenChange={(o) => { if (!o) setDetailId(null); }}>
        {(onClose) => (
          <DialogContent size="lg" onClose={() => onClose(false)}>
            <DialogHeader>
      ...
      <ConfirmDialog
        ...
        title="¿Suspender esta cirugía?"
        description="La cirugía quedará marcada como suspendida y se notificará al médico por email."
      ...
      <ConfirmDialog
        ...
        description="Esta acción no se puede deshacer. El turno se eliminará permanentemente del sistema."
