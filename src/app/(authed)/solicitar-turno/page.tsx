...
import {
  CalendarPlus, Info, User, Stethoscope, Clock, Building2, AlertTriangle, CheckCircle2, ArrowRight,
} from "lucide-react";
import { DIAS_SEMANA, type DiaSemana, type ObraSocial, type TipoAnestesia, type HorarioHabilitado, type ConfigUTI } from "@/lib/types";
...
export default function SolicitarTurnoPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => router.push("/turnos"), 1500);
  };
